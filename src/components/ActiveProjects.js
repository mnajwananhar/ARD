...
const ActiveProjects = ({
  ...
  const shouldScroll =
    filteredProjects && filteredProjects.length > MAX_ITEMS_BEFORE_SCROLL;
  ...
  return (
    <div ref={mainContainerRef}>
      {filteredProjects.length === 0 ? (
        ...
        <div
          className={`space-y-3 ${
            shouldScroll ? "border-r border-gray-700" : ""
          }`}
          style={{
            scrollbarWidth: "thin",
            ...
            paddingRight: shouldScroll ? "10px" : "0",
            marginRight: shouldScroll ? "-10px" : "0",
            paddingBottom: shouldScroll ? "20px" : "0", // Added padding to the bottom
          }}
        >
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="flex items-center ml-auto space-x-2">
                ...
                {/* Check button - hanya toggle status completed/incompleted */}
                <button
                  onClick={() => toggleCompletion(project.id)}
